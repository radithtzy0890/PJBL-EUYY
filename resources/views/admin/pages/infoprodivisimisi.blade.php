...
<body>
  ...
  <div class="container">
    <div class="sidebar">
      ...
      <a href="{{ route('infoprodi') }}" class="active">Info Profil</a>
...
<div class="content">
    ...
    <div class="form-container">
        <form>
            ...
            <input type="text" placeholder="Unggah Visi Misi baru">
            <button class="btn-submit" type="button" onclick="window.location.href='{{ route('infoprodi') }}'">Unggah</button>
        </form>
    </div>
</div>
  </div>
