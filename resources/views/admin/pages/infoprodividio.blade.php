...
<body>
  ...
  <div class="container">
    <div class="sidebar">
      ...
      <a href="kelolakarya.html" >Kelola Karya</a>
      <a href="infoprodi.html" class="active">Info Prodi</a>
      <a href="validasikonten.html">Validasi Konten</a>
...
<div class="content">
    ...
    <div class="form-container">
        <form>
            <label>Vidio</label>
            <input type="text" placeholder="Unggah Vidio baru">
            <button class="btn-submit" type="button" onclick="window.location.href='infoprodi.html'">Unggah</button>
        </form>
    </div>
</div>
  </div>
